...
We support cross origin resource sharing ([CORS](http://www.w3.org/TR/cors/)). All endpoints return the following header.
    ...
    `Access-Control-Allow-Methods: GET,POST,OPTIONS,PUT,PATCH,DELETE` <br>
    `Access-Control-Allow-Headers: ApiKey,Content-Type,Keep-Alive,User-Agent,Cache-Control` <br>
